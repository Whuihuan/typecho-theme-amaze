...
<head>
    ...
    <!-- FancyBox -->
    <link rel="stylesheet" href="<?php $this->options->themeUrl('fancybox/jquery.fancybox.min.css?v=3.3.5'); ?>">
    <!-- CodeHighlight -->
    <style>
        .hljs {
            display: block;
...
<body id="blog">
    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="/"><?php getSiteTitle(); ?></a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        ...
                        <span class="meta">@<?php $this->author(); ?><?php if ($this->author->uid == 1) { ?> <span class="am-icon-user" title="博主"></span><?php } ?> &nbsp;<?php $this->date('Y/m/d H:i'); ?></span>
    ...
    <script src="https://fastly.jsdelivr.net/npm/headroom.js@0.9.4/dist/headroom.min.js"></script>
    <script>
        var postDirectoryBuild = function() {
            var b = function a(l, h) {
                    var k = [],
                        e = typeof h === "object",
                        g = typeof h === "string",
                        j, f, d;
                    for (f = 0, d = l.length; f < d; f++) {
                        j = l[f];
                        if ((j.nodeType === 1 || j.nodeType === 9) && (!h || e && h.test(j.tagName.toLowerCase()) || g && j.tagName.toLowerCase() === h)) {
                            k.push(j)
                        }
                    }
                    return k
                ...
                c = function(e, f, r) {
                    var n = [],
                        ...
                        h, p, d, j, l, s, o, g, k, q;
                    h = (function(i, C, A) {
                        var w = b(i.childNodes, /^h\d$/),
                            x = [],
                            v = 1,
                            B = 1,
                            z = 0,
                            D = 1,
                            t = "directory" + (Math.random() + "").replace(/\D/, ""),
                            B, y, u;
                        while (w.length) {
                            u = w.shift();
                            C.push(u.innerHTML);
                            y = +u.tagName.match(/\d/)[0];
                            if (y > v) {
                                x.push(1);
                                B += 1
                            } else {
                    ...
                    j = p = document.createElement("ul");
                    q = document.createElement("span");
                    q.style = "color:#F38181;font-weight:600;";
                    q.innerHTML = "目录";
                    p.appendChild(q);
                    dirNum = [];
                    for (g = 0, k = h.length; g < k; g++) {
                        ...
                        if (d === 1) {
                            ...
                            if (!j.lastElementChild) {
                                j.appendChild(document.createElement("li"))
                            }
                            j.lastElementChild.appendChild(l);
                            j = l;
                            dirNum.push(0)
                        } else {
                            if (d < 0) {
                        ...
                        o.href = "#" + m[g];
                        o.innerHTML = !r ? n[g] : dirNum.join(".") + " " + n[g];
                        s.appendChild(o);
                        j.appendChild(s)
                    }
                    f.appendChild(p)
                };
            c(document.getElementById("post-content"), document.getElementById("directory"), false)
        };
        postDirectoryBuild();
    </script>
    <script>
